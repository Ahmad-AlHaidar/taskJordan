  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          if (title != null) ...{Text(title??''), 6.verticalSpace},
          Stack(
              ...
              FormBuilderTextField(
                ...
                decoration: decoration ??
                    InputDecoration(
                      ...
                      hintText: hintText,
                      hintStyle: hintStyle ?? TextStyle().copyWith(color: const Color(0xff98A2B3)),
                      ...
                      prefixIconConstraints: prefixIconConstraints ?? BoxConstraints(maxHeight: 40.h, minHeight: 10.h, minWidth: 40.w),
                      ...
                      focusedBorder: focusedBorder ??
                          OutlineInputBorder(
                            borderSide: BorderSide(color: Color(0xff9D00DE)),
                            borderRadius: BorderRadius.circular(8),
                          ),
                    ),
